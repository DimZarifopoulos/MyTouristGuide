...
namespace ERG21
{
    public partial class CampingForm : ItemListForm
    {
        ...
        // (Το DataProvider.GetCamping() επιστρέφει μια List<AppItem>) 
        public CampingForm() : base(DataProvider.GetCamping())
        {
            InitializeComponent();
            this.Text = "MyTouristGuide.GR - Κάμπινκ";
        }
        ...
        private void CampingForm_Load(object sender, EventArgs e)
        {
            ...
            {
                CurrentUser.History.Add("Κάμπινκ");
            }
        }
        // Help button
        private void button3_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Εδώ μπορείτε να βρείτε τις επιλογές για camping της Κρήτης!\nΚάντε κλικ πάνω σε μια φωτογραφία ή ένα όνομα για δείτε περισσοτερες πληροφορίες", "Βοήθεια" 
